...
data class RestuarantModel(val name:String?, val address:String?, val delivery_charge:String?, val image:String?,
    ...
    companion object CREATOR : Parcelable.Creator<RestuarantModel> {
        override fun createFromParcel(parcel: Parcel): RestuarantModel {
            return RestuarantModel(parcel)
        }

        override fun newArray(size: Int): Array<RestuarantModel?> {
