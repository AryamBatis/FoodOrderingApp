...
class PlaceYourOrdedAdapter(val menuList: List<Menus?>?): RecyclerView.Adapter<PlaceYourOrdedAdapter.MyViewHolder> (){

    override fun onCreateViewHolder(
        parent: ViewGroup, viewType: Int
    ): PlaceYourOrdedAdapter.MyViewHolder {
       val view:View = LayoutInflater.from(parent.context).inflate(R.layout.placeyourorder_list_raw,parent,false)
        return MyViewHolder(view)
    }

    override fun onBindViewHolder(holder:PlaceYourOrdedAdapter.MyViewHolder, position: Int) {
